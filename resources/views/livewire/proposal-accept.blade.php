                ...
                <div class="bg-cream-50 rounded-xl p-6 border border-ink-100 sticky top-24">
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-semibold">{{ number_format($proposal->proposed_price * 0.10, 0) }} FCFA</span>
                        </div>
                        <div class="border-t border-ink-100 pt-3 flex justify-between font-bold text-lg">
                            <span>Total</span>
                            <span class="text-ink-900">{{ number_format($proposal->proposed_price, 0) }} FCFA</span>
                        </div>
                    </div>
