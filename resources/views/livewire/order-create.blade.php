    ...
    <div class="container mx-auto px-4 max-w-4xl">
        ...
        <nav class="mb-6 text-sm">
            <ol class="flex items-center gap-2 text-gray-600">
                ...
                <li>→</li>
                <li><a href="{{ route('services.show', $service) }}" class="hover:text-blue-600">{{ Str::limit($service->title, 40) }}</a></li>
                <li>→</li>
                <li class="text-gray-900 font-semibold">Commander</li>
            </ol>
        </nav>
        ...
        <div class="grid lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-6">
                <div class="bg-white rounded-3xl p-8 shadow-lg">
                    <h1 class="text-2xl font-black text-gray-900 mb-6">Votre commande</h1>
                    ...
                    <div class="flex gap-4 p-4 bg-blue-50 rounded-2xl mb-8">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm text-gray-600 mt-1">Par {{ $service->prestataire->name }}</p>
                            <p class="text-sm text-blue-700 font-semibold mt-1">Livraison en {{ $service->delivery_time }} jour(s)</p>
                        </div>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea
                            ...
                            class="w-full px-4 py-3 border-2 border-gray-200 rounded-2xl focus:border-blue-900 focus:ring-4 focus:ring-blue-100 transition resize-none"
                        ></textarea>
                        @error('requirements')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-xs text-gray-400 mt-1">{{ strlen($requirements) }}/2000 caractères (min. 20)</p>
                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            @foreach([
                                ...
                                <label class="cursor-pointer">
                                    ...
                                    <div class="flex items-center gap-3 p-4 border-2 rounded-xl peer-checked:border-blue-900 peer-checked:bg-blue-50 border-gray-200 hover:border-blue-300 transition">
                                        <div class="w-4 h-4 rounded-full border-2 border-gray-300 peer-checked:border-blue-900 flex-shrink-0 flex items-center justify-center">
                                        </div>
            ...
            <div class="lg:col-span-1">
                <div class="bg-white rounded-3xl p-6 shadow-lg sticky top-24">
                    <h2 class="text-lg font-black text-gray-900 mb-6">Récapitulatif</h2>
                    ...
                    <div class="space-y-3 mb-6">
                        ...
                        <div class="border-t pt-3 flex justify-between font-black text-lg">
                            <span>Total</span>
                            <span class="text-blue-900">{{ number_format($service->price, 0) }} FCFA</span>
                        </div>
                    </div>
                    ...
                    <button
                        ...
                        class="w-full bg-blue-900 hover:bg-blue-800 text-white font-bold py-4 rounded-2xl transition shadow-xl disabled:opacity-60 disabled:cursor-not-allowed mb-4"
                    >
                    ...
                    <a href="{{ route('services.show', $service) }}"
                       class="block text-center text-sm text-gray-500 hover:text-gray-700 font-semibold">
                        Annuler
                    </a>
