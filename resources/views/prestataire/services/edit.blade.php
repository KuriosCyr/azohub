<x-app-layout>
    <div class="min-h-screen bg-cream py-8">
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            {{-- Formulaire --}}
            <form action="{{ route('prestataire.services.update', $service) }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="service-form" onsubmit="return validateServiceAreasBeforeSubmit(event)">
                @csrf
                @method('PUT')
                ...
                <div class="bg-cream-50 rounded-xl p-8 border border-ink-100">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-ink-400 mt-1">Minimum 50 caractères</p>
