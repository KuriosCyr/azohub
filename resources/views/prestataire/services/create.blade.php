    ...
    <div class="min-h-screen bg-gray-50 py-8">
        <div class="container mx-auto px-4 max-w-4xl">
            ...
            <div class="mb-8">
                ...
                <h1 class="text-4xl font-black text-gray-900 mb-2">+ Créer un nouveau service</h1>
                <p class="text-gray-600">Remplissez les informations pour créer votre offre de service</p>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" required
                                   ...
                                   class="w-full px-4 py-3 border-2 border-gray-200 rounded-2xl focus:border-blue-900 focus:ring-4 focus:ring-blue-100 transition">
                            <p class="text-xs text-gray-500 mt-1">Soyez clair et précis (max 255 caractères)</p>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="6" required
                                      ...
                                      class="w-full px-4 py-3 border-2 border-gray-200 rounded-2xl focus:border-blue-900 focus:ring-4 focus:ring-blue-100 transition">{{ old('description') }}</textarea>
                            <p class="text-xs text-gray-500 mt-1">Minimum 50 caractères - Soyez détaillé et professionnel</p>
...
- Nettoyage après intervention"
                                      class="w-full px-4 py-3 border-2 border-gray-200 rounded-2xl focus:border-blue-900 focus:ring-4 focus:ring-blue-100 transition">{{ old('what_included') }}</textarea>
                            <p class="text-xs text-gray-500 mt-1">Listez ce qui est compris dans votre service</p>
                ...
                <div class="bg-white rounded-3xl p-8 shadow-lg">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-500 mt-1">Temps estimé pour réaliser le service</p>
                ...
                <div class="bg-white rounded-3xl p-8 shadow-lg">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-2xl p-8 text-center hover:border-blue-500 transition">
                ...
                <div class="flex gap-4">
                    ...
                    <button type="submit" 
                            class="flex-1 bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-blue-900 font-black px-8 py-4 rounded-full transition transform hover:scale-105 shadow-lg">
                        Publier le service
                    </button>
                </div>
            </form>
        ...
        function previewImage(input, previewId) {
            ...
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    preview.innerHTML = `<img src="${e.target.result}" class="max-w-md mx-auto rounded-2xl shadow-lg">`;
                };
