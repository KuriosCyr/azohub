            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
                    ...
                    <div class="text-center">
                        <div class="bg-gradient-to-br from-blue-100 to-blue-200 w-32 h-32 rounded-full flex items-center justify-center mx-auto mb-6 transform hover:scale-110 transition">
                            <x-app-icon name="search" class="w-14 h-14 text-blue-600" />
                        </div>
                    ...
                    {{-- Étape 2 --}}
                    <div class="text-center">
                        <div class="bg-gradient-to-br from-yellow-100 to-yellow-200 w-32 h-32 rounded-full flex items-center justify-center mx-auto mb-6 transform hover:scale-110 transition">
                            <x-app-icon name="card" class="w-14 h-14 text-yellow-600" />
                        </div>
                        <div class="bg-blue-900 text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black">
                            2
                        </div>
                    ...
                    {{-- Étape 3 --}}
                    <div class="text-center">
                        <div class="bg-gradient-to-br from-green-100 to-green-200 w-32 h-32 rounded-full flex items-center justify-center mx-auto mb-6 transform hover:scale-110 transition">
                            <x-app-icon name="check-circle" class="w-14 h-14 text-green-600" />
                        </div>
                        <div class="bg-blue-900 text-white w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black">
                            3
                        </div>
        ...
        <div class="py-20 bg-gray-50">
            <div class="container mx-auto px-4">
                ...
                <div class="grid md:grid-cols-3 gap-12 max-w-6xl mx-auto">
                    {{-- Étape 1 --}}
                    <div class="text-center">
                        <div class="bg-gradient-to-br from-purple-100 to-purple-200 w-32 h-32 rounded-full flex items-center justify-center mx-auto mb-6 transform hover:scale-110 transition">
                    ...
                    <div class="text-center">
                        <div class="bg-gradient-to-br from-blue-100 to-blue-200 w-32 h-32 rounded-full flex items-center justify-center mx-auto mb-6 transform hover:scale-110 transition">
                            <x-app-icon name="rocket" class="w-14 h-14 text-blue-600" />
                        </div>
                        <div class="bg-yellow-400 text-blue-900 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black">
                            2
                        </div>
                    ...
                    <div class="text-center">
                        <div class="bg-gradient-to-br from-green-100 to-green-200 w-32 h-32 rounded-full flex items-center justify-center mx-auto mb-6 transform hover:scale-110 transition">
                            <x-app-icon name="banknotes" class="w-14 h-14 text-green-600" />
                        </div>
                        <div class="bg-yellow-400 text-blue-900 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black">
                            3
                        </div>
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
                    <div class="bg-blue-50 rounded-3xl p-6 text-center transform hover:scale-105 transition">
                        <div class="mb-4"><x-app-icon name="lock" class="w-10 h-10 inline-block text-blue-600" /></div>
                    ...
                    <div class="bg-green-50 rounded-3xl p-6 text-center transform hover:scale-105 transition">
                        <div class="mb-4"><x-app-icon name="card" class="w-10 h-10 inline-block text-green-600" /></div>
                    ...
                    <div class="bg-yellow-50 rounded-3xl p-6 text-center transform hover:scale-105 transition">
                        <div class="mb-4"><x-app-icon name="handshake" class="w-10 h-10 inline-block text-yellow-600" /></div>
