...
// Filet de sécurité : la plupart des formulaires de l'app définissent déjà leurs propres
// messages (ex. 'title.required' => '...') qui prennent le dessus sur ce fichier. Mais toute
// règle de validation SANS message personnalisé retombait jusqu'ici sur la clé brute anglaise
// non traduite (ex. "validation.required" affiché tel quel) faute de ce fichier en français.
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'Le/la :attribute indiqué(e) figure dans une fuite de données connue. Merci d\'en choisir un(e) autre.',
    ],
    ...
    // Noms de champs génériques, utilisés quand une règle n'a pas de message personnalisé et
    // que le nom technique du champ (ex. "email", "password") apparaîtrait sinon tel quel dans
    // le message ci-dessus (ex. "Le champ email doit être...").
    'attributes' => [
        'name' => 'nom',
